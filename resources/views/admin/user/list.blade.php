...
@section('content')
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">List of Users</div>
            </div>
            <div class="ibox-body">
              ...
              <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href="{{ route('admin.user.create') }}" class="btn btn-success"><i class="fa fa-plus"></i>New user</a>
                  </div>
                </div>
                @endif
                  ...
                  <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                    ...
                    @if(\App\Helper\CustomHelper::canView('Manage User|Delete User', 'Super Admin'))
                      <td class="text-center p-1" width="100">
                        @if(\App\Helper\CustomHelper::canView('Manage User', 'Super Admin'))
                          <a href="{{ route('admin.user.manage', $val->id) }}" class="btn btn-success"> <i
