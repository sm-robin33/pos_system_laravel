...
<div class="page-content">
  <div class="ibox">
      <div class="ibox-head">
          <div class="ibox-title">Create new Categories</div>
      </div>
      <div class="ibox-body">
          <div class="row">
              <div class="col-md-12">
              ...
              <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                <a href="{{ route('admin.categories.list') }}" class="btn btn-success">List of Categories</a>
              </div>
                  <form action="{{ route('admin.categories.store') }}" method="post" enctype="multipart/form-data" >
                      @csrf
                <div class="form-row">
                    <div class="required col-md-5">
                        <label for="full_name" class="col-form-label">Categories Name:</label>
                        <div >
                   ...
                   @enderror
                    ...
                    <label><input class="form-check-input" type="checkbox" id="myCheck" onclick="myFunction()" name="checkbox" value=""> Has Parent</label>
                    <select name="parent" id="text" style="display:none" class="form-control text-capitalize">
                        <option value="" disabled selected  class="text-capitalize">Choose a Parent</option>
