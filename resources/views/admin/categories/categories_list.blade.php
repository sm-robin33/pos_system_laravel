...
@section('content')
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">List of Categories</div>
            </div>
            <div class="ibox-body">
            ...
            @endif
              ...
              @if(\App\Helper\CustomHelper::canView('Create Category', 'Super Admin|Cashier'))
            <div class="row">
              @if(session()->has('success'))
                <p class="alert alert-success" role="alert">{!! session()->get('success') !!}</p>
                @endif
                <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                  <a href="{{ route('admin.categories.create') }}" class="btn btn-success"> <i class="fa fa-plus"></i>New Category</a>
                </div>
              </div>
              @endif
               ...
               <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                  ...
                  <td width="200" class="p-1">{{ $val->updated_by }}</td>
                    ...
                    <td class="text-center p-1" width="100">
                        <a href="{{ route('admin.categories.manage', $val->id) }}" class="btn btn-success"> <i
...
=======
          <strong>Are you sure to delete this category?</strong>
>>>>>>> 5cfa9ead8577061226fac10ab9c6214933e4beac
        </div>
