...
@section('content')
    ...
    <div class="page-heading">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item">Create Supplier</li>
        </ol>
    </div>
<div class="page-content">
  <div class="ibox">
      <div class="ibox-head">
          <div class="ibox-title">Create New Supplier</div>
      </div>
      <div class="ibox-body">
          <div class="row">
              <div class="col-md-12">
                   ...
                   @enderror
                        ...
                        <div class="required col-md-5 mt-2">
                            ...
                            <select name="brand_id" required id="text" class="form-control text-capitalize">
                                <option value="" disabled selected  class="text-capitalize">Choose Brand Name</option>
