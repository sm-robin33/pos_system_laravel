...
@endsection
  ...
  @section('content')
    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-head">
                <div class="ibox-title">List of store</div>
            </div>
            <div class="ibox-body">
              ...
              <div class="row">
                  <div class="col-lg-12 col-md-12 col-xl-12 text-right mb-3">
                    <a href=" {{ route('admin.store.create') }} " class="btn btn-success"><i class="fa fa-plus"></i>New Store</a>
                  </div>
                </div>
                @endif
                  ...
                  <thead>
                    ...
                    @foreach($showData as $key => $val)
                     <tr class="@if(($key%2) == 0)gradeX @else gradeC @endif">
                        ...
                        <td class="p-1 text-capitalize">{{ $val->store_name }}</td>
                        ...
                        <td width="200" class="p-1">{{ $val->updated_by }}</td>
                          ...
                          <td class="text-center p-1" width="100">
                              <a href="{{ route('admin.store.manage', $val->id) }}" class="btn btn-success"> <i
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <strong>Are you sure to delete this Store?</strong>
        </div>
